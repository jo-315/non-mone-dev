    ...
    <div class="recruit_detail">
      <table>
        ...
        <ul>
          ...
          <li>
            下記のお問い合わせよりご連絡ください。その後、一度メール等で打ち合わせさせていただいたのち、実際に記事を書いていただければと考えております。</br>
            </br>
            より詳しい情報を、下のマニュアルに載せております。</br>
            </br>
            <div class="align-center">
              <a href="https://moire.xsrv.jp/moire_article_contribution.pdf" target="_blank" rel="noreferrer">moire・記事執筆のお願い.pdf</a>
            </div>
            </br>
            事業計画書はこちらになります。moireについてはここに詳しく載っています。</br>
            </br>
            <div class="align-center">
